...
pub use dto::{DatabaseUrlArgs, SyncCommandReport, SyncTableReport, SyncTablesReport};
use helpers::{decide_upsert, is_conflict_guard_enabled, UpsertDecision};
use sea_orm::{
...
impl SyncService {
    ...
    pub async fn pull(
        ...
        let remote_db = get_remote_db(database_url).await?;
