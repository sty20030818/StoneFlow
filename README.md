...
<p align="center">
  <img src="./src/assets/stoneflow.png" alt="StoneFlow" width="96" />
</p>
...
> 🚧 **预览版 (0.1.0)**：核心功能已比较完整，正在快速迭代中。欢迎提 Issue /
> PR，一起把它打磨成你会每天打开的工具。
...
- **Task
  Inspector 抽屉**：右侧滑出编辑面板（状态 / 优先级 / 截止日期 / 标签 / 归属 / 备注等）
- **批量编辑模式**：多选、整列选择、批量软删除

### 🏆 完成与回顾

- **Finish List 时间线**：永久记录完成任务（可按 Space / Project
  / 日期 / 关键词筛选）
