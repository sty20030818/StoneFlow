...
import { useProjectInspectorStore, useTaskInspectorStore } from '@/features/inspector'
...
import { useWorkspaceEditStore, type WorkspaceEditCommand } from './store/workspace-edit'
