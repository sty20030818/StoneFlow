...
<script setup lang="ts">
	...
	import type { DoneReasonOption, PriorityOption, StatusOption } from '@/shared/config/task'
	import type { SpaceId } from '@/shared/config/space'
	import type { CreateTaskFormState, LinkKindOption, ProjectOption } from '../../../logic/useCreateTaskModal'
