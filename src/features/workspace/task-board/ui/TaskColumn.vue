...
<script setup lang="ts">
	...
	import { getProjectMotionPhaseDelay, useMotionPreset, withMotionDelay } from '@/shared/composables/base/motion'
	import EmptyState from '@/shared/ui/base/EmptyState.vue'
	import TaskStatusIcon from '@/shared/ui/shared/TaskStatusIcon.vue'
