...
<script setup lang="ts">
	...
	import DrawerShell from '../shared/DrawerShell.vue'
	import { DRAWER_CONTENT_CLASS } from '../shared/constants'
	import {
		DrawerBreadcrumbHeader,
		DrawerFooterInfo,
		DrawerLinksSection,
	...
	import { useTaskDrawerInteractions, useTaskDrawerPresentation, useTaskInspectorDrawer } from '../../../logic/task'
	...
	const titleSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 1,
	)
	const prioritySectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 2,
	)
	const locationSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 3,
	)
	const advancedSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 4,
	)
	const tagsSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 5,
	)
	const noteSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 6,
	)
	const linksSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 7,
	)
	const timelineSectionMotion = useProjectInteractionMotionPreset(
		'drawerSection',
		'drawerSectionStart',
		drawerSectionStep * 8,
	)
