	...
	assets: {
		...
		vault: {
			...
			unlock: {
				...
				description: 'The app is restoring encrypted entries into a locally usable session.',
			},
			export: {
				title: 'Export Encrypted Vault Bundle',
				description: 'The exported file stays encrypted and requires the same password during import.',
				hint: 'This password protects only this export bundle. If you lose it, the bundle cannot be restored.',
				password: 'Export Password',
				confirmPassword: 'Confirm Export Password',
				action: 'Export Encrypted Bundle',
			},
			import: {
				title: 'Import Encrypted Vault Bundle',
				description: 'Choose a previously exported bundle and enter its password to restore entries.',
				hint: 'Imported entries are re-encrypted with the current device Vault master key before being saved.',
				pickFile: 'Choose Import File',
			...
			toast: {
				...
				favoriteAddedTitle: 'Added to favorites',
				favoriteRemovedTitle: 'Removed from favorites',
				exportedTitle: 'Encrypted export completed',
				exportFailedTitle: 'Failed to export vault bundle',
				exportPasswordMismatchTitle: 'Please make sure the export passwords match',
				importedTitle: 'Vault bundle imported',
				importedDescription: 'Restored {count} vault entries',
				importFailedTitle: 'Failed to import vault bundle',
				importMissingFileTitle: 'Please choose an import file and enter its password',
			},
		},
	},
	trash: {
