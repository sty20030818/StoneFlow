...
export function createStoneFlowColadaOptions(options: Pick<PiniaColadaOptions, 'plugins'> = {}): PiniaColadaOptions {
	return {
		queryOptions: {
...
export function createStoneFlowQueryHooksPlugin(options: Parameters<typeof PiniaColadaQueryHooksPlugin>[0]) {
