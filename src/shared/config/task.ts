import { PRIORITY_OPTIONS, type PriorityOption } from '@/shared/config/priority'
import type { TaskDoneReasonValue, TaskPriorityValue, TaskStatusValue } from '@/shared/types/domain/task'
...
export type { TaskDoneReasonValue, TaskPriorityValue, TaskStatusValue } from '@/shared/types/domain/task'
